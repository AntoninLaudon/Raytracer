...
Math::Vector3D operator+(const Math::Vector3D &v1, double scalar)
{
    return Math::Vector3D(v1.getX() + scalar, v1.getY() + scalar, v1.getZ() + scalar);
}
Math::Vector3D operator+(double scalar, const Math::Vector3D &v1)
{
    return Math::Vector3D(v1.getX() + scalar, v1.getY() + scalar, v1.getZ() + scalar);
}
...
void operator+=(Math::Vector3D &v1, Math::Vector3D &v2)
{
    v1.setX(v1.getX() + v2.getX());
    v1.setY(v1.getY() + v2.getY());
    v1.setZ(v1.getZ() + v2.getZ());
}
void operator+=(Math::Vector3D &v1, double scalar)
{
